...
public class VerifyOTP extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textMobile.setText(String.format("+65-%s", getIntent().getStringExtra("mobile")));
        ...
        buttonVerify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (verificationId !=null){
                    ...
                    PhoneAuthCredential phoneAuthCredential = PhoneAuthCredential.zzc(verificationId,code);
                    ...
                    FirebaseAuth.getInstance().signInWithCredential(phoneAuthCredential).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (task.isSuccessful()){
                                Intent intent = new Intent(getApplicationContext(), Thingspeak.class);
        ...
        findViewById(R.id.textResendOTP).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                PhoneAuthProvider.getInstance().verifyPhoneNumber(
                        "+65" + getIntent().getStringExtra("mobile"), 60, TimeUnit.SECONDS, VerifyOTP.this, new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                            @Override
